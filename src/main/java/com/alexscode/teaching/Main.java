...
public class Main {
    public static void main(String[] args) {
        ...
        Objectives obj = new Objectives(tap_11_medium); // the instance 

        TAPSolver solver = new Ficaro(); // put the class you want to compile here
        List<Integer> solution = solver.solve(tap_11_medium); // the instance 
        ...
        System.out.println("Feasible ? " + isSolutionFeasible(tap_11_medium, solution)); // the instance 
    }
